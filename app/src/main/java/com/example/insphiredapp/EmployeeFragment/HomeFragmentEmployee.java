...
import com.example.insphiredapp.EmployeeActivity.FavouriteJobsActivity;
...
public class HomeFragmentEmployee extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* linearUploadCv = view.findViewById(R.id.linearUploadCv);
        linearFavourite = view.findViewById(R.id.linearFavourite);*/
