...
public class EmployeeHistoryAdapter extends RecyclerView.Adapter<EmployeeHistoryAdapter.ViewHolder> {
    ...
    public EmployeeHistoryAdapter(Context context, List<EmployeeHistoryCompleteList> employeeHistoryCompleteLists) {
    ...
    public void onBindViewHolder(@NonNull EmployeeHistoryAdapter.ViewHolder holder, int position) {
        Glide.with(context).load(Api_Client.BASE_URL_IMAGES + employeeHistoryCompleteLists.get(position).getImage()).into(holder.imgEEH);
