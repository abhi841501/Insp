...
public class BookingActivity extends AppCompatActivity {
    ...
    startDateBookingTxt,EndDateBookingTxt;
    TextView AmountBookingTxt;
    AppCompatButton BookNowBtnBooking;
    GetBookingDetailModelData getBookingDetailModelData;
    private String SlotIdd,EmployeeId,StrName,strTotalAmount,strStartDate,strEndDate,strLocation,strssDate,streeDate,UserId
            ,strCatName,strSd,strEd,strDailyAmount,strAddress,strEmployeeId,strEmployeeIdFav,strFullNameFav,strCatNameFav,strSdFav,strEdFav,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inits();
        SlotIdd = getIntent().getStringExtra("SlotId");
    ...
    private void  getEmployeeDetailsApi() {
        ...
        retrofit2.Call<GetBookingDetailModel> call = service.GET_BOOKING_DETAIL_MODEL_CALL("user_detail?user_id="+UserId+"&time_slot_id="+SlotIdd+"&employee_id="+EmployeeId);
    ...
    private void  employeeBookApi() {
        ...
        pd.show();
        Api service = Api_Client.getClient().create(Api.class);
        retrofit2.Call<BookingModel> call = service.BOOKING_MODEL_CALL(EmployeeId,UserId, strTotalAmount,SlotIdd);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            intent.putExtra("SlotId",SlotIdd);
