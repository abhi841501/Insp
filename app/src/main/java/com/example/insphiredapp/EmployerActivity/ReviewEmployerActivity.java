...
public class ReviewEmployerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backArrowReviews.setOnClickListener(new View.OnClickListener() {
         ...
         EmpId= getIntent().getStringExtra("strEmployee");
    ...
    private void  GetReviewsEmployee() {
        ...
        retrofit2.Call<GetReviewModel> call = service.GET_REVIEW_MODEL_CALL("show_review?+employee_id="+EmpId);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            rating_barreviewsss.setRating(Float.parseFloat(strrating_barreviewsss));
