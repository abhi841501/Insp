...
public class SelectSlotsActivity extends AppCompatActivity {
    ...
    private String UserId,SlotId,EmployeeId;
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            selectSlotsAdapter = new SelectSlotsAdapter(SelectSlotsActivity.this, getCreateSlotsModelDataList);
                            recyclerSlots.setAdapter(selectSlotsAdapter);

                            for (int i = 0; i<getCreateSlotsModelDataList.size(); i++)
                            {
                                SlotId = String.valueOf(getCreateSlotsModelDataList.get(i).getId());
                            }
                            Log.e("hello", "getData: " );
                            // Id  = profileGetData.getId();

                            Toast.makeText(SelectSlotsActivity.this, msg, Toast.LENGTH_SHORT).show();
