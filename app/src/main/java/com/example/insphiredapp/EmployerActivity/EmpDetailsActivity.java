...
public class EmpDetailsActivity extends AppCompatActivity {
    ...
    AppCompatButton BookNowBtn;
    TextView viewReview,EmpdName,empdDesig,empdRating,ViewCv11;
    RatingBar rating_barId;
    String Id,strId,fav;
    Float empdeRating,strRatingfv;
    FavouriteDataList favouriteDataList;
    private String UserId,strempdDesig,strData,strImg,strIddd,strEmployeeID,strEmployee;
   ...
   // boolean isCheck = true ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inits();
        strId = getIntent().getStringExtra("BookingIdd");
        ...
        empdeRating = getIntent().getFloatExtra("Rating",0);
            ...
            rating_barId.setRating(Float.parseFloat(String.valueOf(empdeRating)));
        ...
        BookNowBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpDetailsActivity.this,BookingActivity.class);
                startActivity(intent);
            }
        });
        ...
        viewReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("strEmployee",strEmployee);
                startActivity(intent);
            }
        });
    }
    ...
    private void  ViewCVApi() {
        ...
        retrofit2.Call<ShowCvModel> call = service.SHOW_CV_MODEL_CALL("show_cv?employee_id="+strId);
    ...
    private void  addFavApi() {
        ...
        pd.show();
        Api service = Api_Client.getClient().create(Api.class);
        retrofit2.Call<Favourite_employee_model> call = service.FAVOURITE_EMPLOYEE_MODEL_CALL(strId,UserId);
