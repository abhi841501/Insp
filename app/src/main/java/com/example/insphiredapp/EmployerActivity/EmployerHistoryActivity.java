...
public class EmployerHistoryActivity extends AppCompatActivity {
    ...
    private void  GetHistoryEmployee() {
        ...
        retrofit2.Call<GetEmployeeHistoryModel> call = service.GET_EMPLOYEE_HISTORY_MODEL_CALL("my_booked_employer_history?user_id="+UserId);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            employerHistoryAdapter = new EmployerHistoryAdapter(EmployerHistoryActivity.this,getEmployeeHistoryModelData);
