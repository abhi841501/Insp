...
public class EmployeeHistoryActivity extends AppCompatActivity {
    ...
    private void  CancelledHistoryApi() {
        ...
        final ProgressDialog pd = new ProgressDialog(EmployeeHistoryActivity.this);
        pd.setCancelable(false);
        pd.setMessage("loading...");
        pd.show();
        Api service = Api_Client.getClient().create(Api.class);
        retrofit2.Call<CancelEmployeeHistoryModel> call = service.CANCEL_EMPLOYEE_HISTORY_MODEL_CALL("employee_job_history?user_id="+UserId+"&switch_id="+1);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            cancelHistoryAdapter = new CancelHistoryAdapter(EmployeeHistoryActivity.this,cancelEmployeeHistoryList);
    ...
    private void  CompletedEmployeeHistoryApi() {
        ...
        pd.show();
        Api service = Api_Client.getClient().create(Api.class);
        retrofit2.Call<EmployeeHistoryModel> call = service.EMPLOYEE_HISTORY_MODEL_CALL("employee_job_history?user_id="+UserId+"&switch_id="+0);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (success.equals("true")|| (success.equals("True"))) {
                            ...
                            employeeHistoryAdapter = new EmployeeHistoryAdapter(EmployeeHistoryActivity.this,employeeHistoryCompleteLists);
